...
-(UILabel *)statusLabel
{
    if (!_statusLabel) {
        ...
        statusLabel.textColor = [ColorUtility colorWithHexString:@"a3a3a3"];
        statusLabel.backgroundColor = [UIColor clearColor];
        statusLabel.textAlignment = NSTextAlignmentCenter;
        [self addSubview:_statusLabel = statusLabel];
    }
...
{
    if (!_arrowImage) {
//        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:MJRefreshSrcName(@"new_arrow")]];
//        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"new_shangla_arrow"]];
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"arrow_scroll.png"]];
...
//    self.arrowImage.center = CGPointMake(arrowX, self.height * 0.5);
    ...
    [self.arrowImage setFrame:CGRectMake(leftSide, 72, width_arraowImageV, width_arraowImageV)];
    // 2.指示器
