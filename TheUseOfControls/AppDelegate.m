...
{
//    NSDictionary* dicTemp = [[HttpNewEngine sharedInstance] generateHeader];
    NSDictionary* dicTemp = [NSDictionary dictionary];
    NSString *PU_UA = [dicTemp valueForKey:@"User-Agent"];
    
    NSString *newAgent = [NSString stringWithFormat:@"%@",PU_UA];
